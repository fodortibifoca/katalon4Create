...
WebUI.openBrowser('https://www.google.rs')
...
urlGoogleSearchSRB = WebUI.getUrl()

System.out.println(urlGoogleSearchSRB)
...
Document document = Jsoup.connect(urlGoogleSearchSRB).userAgent(USER_AGENT).get()
